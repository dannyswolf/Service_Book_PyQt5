...
class Ui_add_new_machine_window(QtWidgets.QWidget):
    ...
    def setupUi(self, add_new_machine_window):
        ...
        self.gridLayout.addWidget(self.serial_number_label, 1, 2, 1, 1)
        # Categories Label
        ...
        self.gridLayout.addWidget(self.categories_label, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.copier_model_label, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.categories_combobox, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.companies_combobox, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.serial_number_lineEdit, 2, 2, 1, 1)
