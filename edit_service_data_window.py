...
class Ui_Edit_Service_Data_Window(QtWidgets.QWidget):
    ...
    def setupUi(self, Edit_Service_Data_Window):
        ...
        Edit_Service_Data_Window.resize(637, 472)
        icon = QtGui.QIcon()
        ...
        Edit_Service_Data_Window.setWindowFilePath("")
        ...
        self.reason_lineEdit.setMinimumSize(QtCore.QSize(300, 35))
        ...
        self.company_lineEdit.setMinimumSize(QtCore.QSize(300, 35))
        ...
        self.companies_combobox.setCurrentText("")
        ...
        self.category_lineEdit.setMinimumSize(QtCore.QSize(300, 35))
        ...
        self.technician_lineEdit.setMinimumSize(QtCore.QSize(300, 35))
