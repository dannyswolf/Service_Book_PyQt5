...
import traceback
from db import Melanakia, Toner, Copiers, Orders, store_session
...
class Ui_edit_consumables_window(QtWidgets.QMainWindow):   # Πρέπει να κληρονομήσει απο QMainWindow for pyqtSignal to work
    ...
    def edit_consumable(self):
        ...
        # Show images
        self.images_path = os.path.join(STORE_SPARE_PARTS_ROOT, f"{self.selected_table.__tablename__}", f"{self.selected_id}")
