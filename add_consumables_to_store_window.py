...
import traceback
from db import Melanakia, Toner, Copiers, Orders, store_session, get_spare_parts
...
class Ui_Add_Consumables_Window(QtWidgets.QMainWindow):   # Πρέπει να κληρονομήσει απο QMainWindow for pyqtSignal to work
    window_closed = QtCore.pyqtSignal()  # Το Signal πρεπει να είναι εκτός __init__ δεν δουλευει αλλιως

    def __init__(self, *args, **kwargs):
        super(Ui_Add_Consumables_Window, self).__init__(*args, **kwargs)
    ...
    def setupUi(self, Add_Consumables_Window):
        ...
        # self.orders_btn = QtWidgets.QToolButton(Add_Consumables_Window)
        ...
        # Προηγούμενη
        self.previous_btn = QtWidgets.QToolButton(Add_Consumables_Window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        # Επόμενη
        self.next_btn = QtWidgets.QToolButton(Add_Consumables_Window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        # Προσθήκη αρχείου
        self.add_file_btn = QtWidgets.QToolButton(Add_Consumables_Window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        # Save_file btn
        self.save_file_btn = QtWidgets.QToolButton(Add_Consumables_Window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.open_pdf_file_btn = QtWidgets.QToolButton(Add_Consumables_Window)
        ...
        # Διαγραφή αρχείου
        self.delete_file_btn = QtWidgets.QToolButton(Add_Consumables_Window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        # Διαγραφή προιόντος
        self.delete_spare_part_btn = QtWidgets.QToolButton(Add_Consumables_Window)
        ...
        # Esc
        self.shortcut_esc = QtWidgets.QShortcut(QtGui.QKeySequence('Escape'), Add_Consumables_Window)
        self.shortcut_esc.activated.connect(lambda: self.close())

        self.retranslateUi(Add_Consumables_Window)
        QtCore.QMetaObject.connectSlotsByName(Add_Consumables_Window)

    def retranslateUi(self, Add_Consumables_Window):
        _translate = QtCore.QCoreApplication.translate
        # edit_consumables_window.setWindowTitle(_translate("edit_consumables_window", "Επεξεργασία αναλώσιμου"))
        self.customers_label.setText(_translate("Add_Consumables_Window", "Πελάτες"))
        self.quality_label.setText(_translate("Add_Consumables_Window", "Ποιότητα"))
        self.code_label.setText(_translate("Add_Consumables_Window", "Κωδικός"))
        self.pieces_label.setText(_translate("Add_Consumables_Window", "Τεμάχια"))
        self.pages_label.setText(_translate("Add_Consumables_Window", "Σελίδες"))
        self.company_label.setText(_translate("Add_Consumables_Window", "Εταιρεία"))
        self.save_file_btn.setText(_translate("Add_Consumables_Window", "Αποθήκευση αρχείου"))
        self.add_file_btn.setText(_translate("Add_Consumables_Window", "Προσθήκη αρχείου"))
        self.total_label.setText(_translate("Add_Consumables_Window", "Σύνολο"))
        self.description_label.setText(_translate("Add_Consumables_Window", "Περιγραφή"))
        self.cosumable_label.setText(_translate("Add_Consumables_Window", "Αναλώσιμο"))
        self.price_label.setText(_translate("Add_Consumables_Window", "Τιμή"))
        self.previous_btn.setText(_translate("Add_Consumables_Window", "Προηγούμενη"))
        self.comments_label.setText(_translate("Add_Consumables_Window", "Παρατηρήσης"))
        # self.orders_btn.setText(_translate("Add_Consumables_Window", "Προσθήκη στίς παραγγελίες"))
        self.delete_file_btn.setText(_translate("Add_Consumables_Window", "Διαγραφή αρχείου"))
        self.next_btn.setText(_translate("Add_Consumables_Window", "Επόμενη"))
        self.save_btn.setText(_translate("Add_Consumables_Window", "Αποθήκευση"))
        self.open_pdf_file_btn.setText(_translate("Add_Consumables_Window", "Ανοιγμα αρχείου pdf"))
        self.delete_spare_part_btn.setText(_translate("Add_Consumables_Window", "Διαγραφή προϊόντος"))
...
if __name__ == "__main__":
    ...
    app.setStyle("Fusion")
    Add_Consumables_Window = QtWidgets.QWidget()
    ui = Ui_edit_consumables_window()
    ui.setupUi(Add_Consumables_Window)
    Add_Consumables_Window.show()
    sys.exit(app.exec_())
