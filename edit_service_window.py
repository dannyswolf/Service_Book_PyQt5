...
from db import (check_if_actions_service_data_exist, Service_data, service_session, check_if_reason_service_data_exist,
                fetch_service_reasons, fetch_service_actions,get_consumables_from_service_id,
                get_spare_part_from_code_from_all_db, get_consumable_from_id, store_session)
...
class Ui_Edit_Service_Window(QtWidgets.QWidget):
    ...
    def setupUi(self, Edit_Service_Window):
        Edit_Service_Window.setObjectName("Edit_Task_Window")
        Edit_Service_Window.setWindowModality(QtCore.Qt.WindowModal)
        Edit_Service_Window.resize(841, 600)
        Edit_Service_Window.setMaximumSize(QtCore.QSize(16777213, 16777215))
        Edit_Service_Window.setWindowTitle(f"Επεξεργασία εργασίας {VERSION}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/service.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Edit_Service_Window.setWindowIcon(icon)
        Edit_Service_Window.setWindowFilePath("")
        self.gridLayout_3 = QtWidgets.QGridLayout(Edit_Service_Window)
        self.gridLayout_3.setObjectName("gridLayout_3")

        # Top Label
        self.top_label = QtWidgets.QLabel(Edit_Service_Window)
        ...
        # Tabs Καρτέλες
        self.tabWidget = QtWidgets.QTabWidget(Edit_Service_Window)
        ...
        self.gridLayout_2.addWidget(self.technician_lineEdit, 1, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.reason_label, 2, 0, 1, 3)
        # reason edit
        ...
        self.gridLayout_2.addWidget(self.reason_lineEdit, 3, 0, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.action_label, 4, 0, 1, 3)
        # action edit
        ...
        self.gridLayout_2.addWidget(self.action_lineEdit, 5, 0, 1, 3)
        ...
        # Save btn
        self.save_toolButton = QtWidgets.QToolButton(Edit_Service_Window)
        ...
        # Email btn
        self.email_toolButton = QtWidgets.QToolButton(Edit_Service_Window)
        ...
        # Print btn
        self.print_toolButton = QtWidgets.QToolButton(Edit_Service_Window)
        ...
        # Esc
        self.shortcut_esc = QtWidgets.QShortcut(QtGui.QKeySequence('Escape'), Edit_Service_Window)
        self.shortcut_esc.activated.connect(self.close)

        self.retranslateUi(Edit_Service_Window)
        self.tabWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(Edit_Service_Window)
        self.fetch_service_data()

    def retranslateUi(self, Edit_Task_Window):
        _translate = QtCore.QCoreApplication.translate
        self.delete_task_toolButton.setText(_translate("Edit_Service_Window", "   Διαγραφή\n   εργασίας"))
        self.top_label.setText(_translate("Edit_Service_Window", "Επεξεργασία εργασίας"))
        self.save_toolButton.setText(_translate("Edit_Service_Window", "Αποθήκευση"))
        self.email_toolButton.setText(_translate("Edit_Service_Window", "..."))
        self.action_label.setText(_translate("Edit_Service_Window", "Ενέργειες"))
        self.notes_label.setText(_translate("Edit_Service_Window", "Σημειώσεις"))
        self.date_label.setText(_translate("Edit_Service_Window", "Ημερομηνία"))
        self.reason_label.setText(_translate("Edit_Service_Window", "Σκοπός εργασίας"))
        self.add_action_toolButton.setText(_translate("Edit_Service_Window", "..."))
        self.next_service_label.setText(_translate("Edit_Service_Window", "Επ. Service"))
        self.cost_label.setText(_translate("Edit_Service_Window", "Κόστος"))
        self.add_reason_toolButton.setText(_translate("Edit_Service_Window", "..."))
        self.technician_label.setText(_translate("Edit_Service_Window", "Τεχνικός"))
        self.counter_label.setText(_translate("Edit_Service_Window", "Μετρητής"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.work_tab), _translate("Edit_Service_Window", "Εργασία"))
        self.add_spare_part_from_store_toolButton.setText(_translate("Edit_Service_Window", "  Προσθήκη ανταλλ. \n"
                                                                                         "  εντός αποθήκης"))
        self.add_files_toolButton.setText(_translate("Edit_Service_Window", "  Προσθήκη αρχείων"))
        self.delete_spare_part_toolButton.setText(_translate("Edit_Service_Window", "    Διαγραφή ανταλλ."))
        self.view_files_toolButton.setText(_translate("Edit_Service_Window", "   Προβολή αρχείων"))
        self.spare_parts_treeWidget.setSortingEnabled(True)
        self.add_spare_part_toolButton.setText(_translate("Edit_Service_Window", "Προσθήκη ανταλλ. \n"
                                                                              " εκτός αποθήκης"))
        self.spare_parts_label.setText(_translate("Edit_Service_Window", "Ανταλλακτικά"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.spare_parts_tab),
                                  _translate("Edit_Service_Window", "Ανταλλακτικά"))
    ...
    def fetch_service_data(self):
        ...
        self.service_actions = sorted(self.service_actions)
    ...
    def get_service_data(self):
        self.dateEdit.setDate(QtCore.QDate.fromString(self.selected_service.Ημερομηνία, "dd'/'MM'/'yyyy"))
        self.technician_lineEdit.setText(self.selected_service.Τεχνικός)
        self.counter_lineEdit.setText(self.selected_service.Μετρητής)
        self.next_service_lineEdit.setText(self.selected_service.Επ_Service)
        self.cost_lineEdit.setText(self.selected_service.Price)
        self.reason_lineEdit.setText(self.selected_service.Σκοπός_Επίσκεψης)
        self.dte_lineEdit.setText(self.selected_service.ΔΤΕ)
        self.action_lineEdit.setText(self.selected_service.Ενέργειες)
        self.notes_textEdit.setText(self.selected_service.Σημειώσεις)
        old_text = self.notes_textEdit.toPlainText()
        append_text = f"-------------------------------- {user} {today.replace(' ', '/')} --------------------------------\n"
        len_append_text = len(append_text)
        if old_text[-len_append_text:] != append_text:  # ελεγχος αν στο τελος γράφει το append_text
    ...
    def show_spare_parts(self):
        ...
        for index, item in enumerate(self.selected_service_spare_parts):
    ...
    def send_mail(self):
        ...
        self.show_send_email.selected_service_id = self.selected_service.ID
    ...
    def delete_task(self):
        if self.selected_service_spare_parts:
...
if __name__ == "__main__":
    ...
    app.setStyle("Fusion")
    Edit_Service_Window = QtWidgets.QWidget()
    ui = Ui_Edit_Service_Window()
    ui.setupUi(Edit_Service_Window)
    Edit_Service_Window.show()
    sys.exit(app.exec_())
