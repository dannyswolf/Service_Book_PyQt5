...
from db import Brother, Canon, Epson, Konica, Kyocera, Lexmark, Oki, Ricoh, Samsung, Sharp, Orders, store_session, get_spare_parts
...
class Ui_Add_Spare_Parts_Window(QMainWindow):  # Πρέπει να κληρονομήσει απο QMainWindow for pyqtSignal to work
    window_closed = pyqtSignal()  # Το Signal πρεπει να είναι εκτός __init__ δεν δουλευει αλλιως

    def __init__(self, *args, **kwargs):
        super(Ui_Add_Spare_Parts_Window, self).__init__(*args, **kwargs)
    ...
    def setupUi(self, Add_Spare_Parts_Window):
        Add_Spare_Parts_Window.setObjectName("edit_spare_parts_window")
        Add_Spare_Parts_Window.resize(400, 600)
        self.gridLayout = QtWidgets.QGridLayout(Add_Spare_Parts_Window)
        self.gridLayout.setObjectName("gridLayout")
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        # Image
        self.image_label = QtWidgets.QLabel(Add_Spare_Parts_Window)
        ...
        # Part no
        self.part_no_label = QtWidgets.QLabel(Add_Spare_Parts_Window)
        ...
        self.lineEdit_part_no = QtWidgets.QLineEdit(Add_Spare_Parts_Window)
        ...
        # Περιγραφή
        self.description_label = QtWidgets.QLabel(Add_Spare_Parts_Window)
        ...
        self.textEdit_description = QtWidgets.QTextEdit(Add_Spare_Parts_Window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        # Κωδικός
        self.code_label = QtWidgets.QLabel(Add_Spare_Parts_Window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lineEdit_code = QtWidgets.QLineEdit(Add_Spare_Parts_Window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        # Τεμάχια
        self.pieces_label = QtWidgets.QLabel(Add_Spare_Parts_Window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lineEdit_pieces = QtWidgets.QLineEdit(Add_Spare_Parts_Window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        # Σχόλια - παρτατηρήσης
        self.comments_label = QtWidgets.QLabel(Add_Spare_Parts_Window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.textEdit_comments = QtWidgets.QTextEdit(Add_Spare_Parts_Window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        # Αποθήκευση
        self.save_btn = QtWidgets.QToolButton(Add_Spare_Parts_Window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.save_btn.sizePolicy().hasHeightForWidth())
        ...
        # self.add_to_orders_btn = QtWidgets.QToolButton(Add_Spare_Parts_Window)
        ...
        # Προηγούμενο αρχείο
        self.previous_image_btn = QtWidgets.QToolButton(Add_Spare_Parts_Window)
        ...
        # Επόμενο αρχείο
        self.next_image_btn = QtWidgets.QToolButton(Add_Spare_Parts_Window)
        ...
        # Προσθήκη αρχείου
        self.add_file_btn = QtWidgets.QToolButton(Add_Spare_Parts_Window)
        ...
        # Αποθήκευση αρχείου
        self.save_file_btn = QtWidgets.QToolButton(Add_Spare_Parts_Window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        # Διαγραφή αρχείου
        self.delete_file_btn = QtWidgets.QToolButton(Add_Spare_Parts_Window)
        ...
        self.open_pdf_file_btn = QtWidgets.QToolButton(Add_Spare_Parts_Window)
        ...
        # Διαγραφή προιόντος
        self.delete_spare_part_btn = QtWidgets.QToolButton(Add_Spare_Parts_Window)
        ...
        # Esc
        self.shortcut_esc = QtWidgets.QShortcut(QtGui.QKeySequence('Escape'), Add_Spare_Parts_Window)
        self.shortcut_esc.activated.connect(lambda: self.close())

        self.retranslateUi(Add_Spare_Parts_Window)
        QtCore.QMetaObject.connectSlotsByName(Add_Spare_Parts_Window)

    def retranslateUi(self, Add_Spare_Parts_Window):
        ...
        self.previous_image_btn.setText(_translate("Add_Spare_Parts_Window", "Προηγούμενη"))
        self.next_image_btn.setText(_translate("Add_Spare_Parts_Window", "Επόμενη"))
        self.comments_label.setText(_translate("Add_Spare_Parts_Window", "Σχόλια"))
        self.save_file_btn.setText(_translate("Add_Spare_Parts_Window", "Αποθήκευση αρχείου"))
        self.open_pdf_file_btn.setText(_translate("Add_Spare_Parts_Window", "Ανοιγμα αρχείου pdf"))
        self.pieces_label.setText(_translate("Add_Spare_Parts_Window", "Τεμάχια"))
        # self.add_to_orders_btn.setText(_translate("Add_Spare_Parts_Window", "Προσθήκη στις παραγγελίες"))
        self.description_label.setText(_translate("Add_Spare_Parts_Window", "Περιγραφή"))
        self.code_label.setText(_translate("Add_Spare_Parts_Window", "Κωδικός"))
        self.add_file_btn.setText(_translate("Add_Spare_Parts_Window", "Προσθήκη αρχείου"))
        self.delete_file_btn.setText(_translate("Add_Spare_Parts_Window", "Διαγραφή αρχείου"))
        self.part_no_label.setText(_translate("Add_Spare_Parts_Window", "Part No"))
        self.save_btn.setText(_translate("Add_Spare_Parts_Window", "Αποθήκευση"))
        self.delete_spare_part_btn.setText(_translate("Add_Spare_Parts_Window", "Διαγραφή προϊόντος"))
    ...
    def save_changes(self):
        ...
        try:
            ...
            if self.item is None:
                ...
                if store_session.query(exists().where(self.selected_table.ΚΩΔΙΚΟΣ == self.code)).scalar():
                    QtWidgets.QMessageBox.critical(None, "Σφάλμα", f"O κωδικός {self.code} υπάρχει")
                    return
                # Ελεγχος αν υπάρχει το part no
                all_parts = store_session.query(self.selected_table.PARTS_NR).all()  # [('14501',), ('LU7179001',)]
...
if __name__ == "__main__":
    ...
    app.setStyle("Fusion")
    Add_Spare_Parts_Window = QtWidgets.QWidget()
    ui = Ui_Add_Spare_Parts_Window()
    ui.setupUi(Add_Spare_Parts_Window)
    Add_Spare_Parts_Window.show()
    sys.exit(app.exec_())
